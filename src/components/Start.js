    ...
    <div className='flex h-full w-full items-center justify-start mb:justify-center pl-[17vw] mb:pl-0 pb-32'>
      <div className='flex flex-col items-center justify-center z-0'>
        ...
        <div className='mt-10'>
          <button
            type="button"
            className="bg-white uppercase px-10 py-5 mr-2 rounded-full text-mattis-pink outline-mattis-pink outline-1 outline hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
              boka tid - stockholm
          </button>
          <button
            type="button"
            className="bg-white uppercase px-10 py-5 ml-2 rounded-full text-mattis-pink outline-mattis-pink outline-1 outline hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
              boka tid - dalarna
          </button>
        </div>
        <button
