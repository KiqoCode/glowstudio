...
const Welcome = () => {
  ...
  return (
    <div ref={ref} className='bg-mattis-light-pink block w-full h-1/2'>

      <div className='flex flex-col text-center px-3 py-[5rem] mb:py-[3rem] items-center justify-center'>
